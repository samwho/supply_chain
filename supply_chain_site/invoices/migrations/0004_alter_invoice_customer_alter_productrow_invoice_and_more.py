...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('invoices', '0003_alter_invoice_customer_alter_productrow_invoice_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='invoice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='invoices.invoice'),
        ),
        migrations.AlterField(
            model_name='productrow',
            name='product',
